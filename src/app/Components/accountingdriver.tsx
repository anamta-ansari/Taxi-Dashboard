  ...
  return (
    <>
      <div className="p-5 dark:bg-[#161c24]">
        <h1 className="text-2xl font-semibold text-gray-900 mb-2 dark:text-gray-300">Drivers Wallet</h1>
        <p className="text-sm text-gray-500">List of all drivers wallets</p>

        <div className="flex flex-col sm:flex-row gap-2 my-5">
          <div className="bg-white dark:text-gray-300 dark:bg-[#161c24] dark:border-gray-500 rounded-lg border flex flex-col items-centre  w-full sm:w-1/2 py-5">
            <p className="text-sm text-gray-500  pl-5 mb-2 dark:text-gray-300">Total drivers wallet</p>
            <p className="text-sm text-gray-500  pl-5 dark:text-gray-300">3367</p>
          </div>
          <div className="bg-white rounded-lg border dark:bg-[#161c24] dark:border-gray-500 flex flex-col items-centre w-full  sm:w-1/2 py-5">
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center gap-3 mb-4">
          ...
          <div className="relative w-[80%]  md:w-auto mt-2 md:mt-0">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-white dark:bg-[#161c24] dark:border-gray-500 border border-gray-300 rounded-md text-sm w-full md:w-auto"
            >
            ...
            {statusOpen && (
              <div className="absolute top-full left-0 mt-1 bg-white dark:bg-[#161c24] dark:border-gray-500 border rounded-md shadow-lg z-10 w-48">
                <button onClick={() => setStatusOpen(false)} className="block w-full text-left px-4 py-2 text-sm ">USD</button>
                <button onClick={() => setStatusOpen(false)} className="block w-full text-left px-4 py-2 text-sm ">Unselect all</button>
              </div>
            )}
          </div>
        ...
        <div className="max-h-44 overflow-y-auto">
          <table className="w-full border border-gray-300 text-left ">
            <thead>
              <tr className="bg-gray-100 dark:bg-[#161c24] ">
