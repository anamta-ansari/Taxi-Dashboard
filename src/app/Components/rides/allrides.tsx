            ...
            <table className="w-full min-w-max">
              <thead className="bg-gray-50 dark:bg-[#161c24] border-b">
                <tr>
                  ...
                  <th className="px-4 py-3 dark:text-gray-300 text-left text-sm font-semibold text-gray-700">Driver</th>
                  ...
                  <th className="px-4 py-3 dark:text-gray-300 text-left text-sm font-semibold text-gray-700">Payment Status</th>
                  <th className="px-4 py-3 dark:text-gray-300 text-left text-sm font-semibold text-gray-700">Ride Status</th>
              ...
              <tbody>
                {users.map((u) => (
                  <tr key={u.id} className="border-b ">
                    ...
                    <td className="px-4 py-3 dark:text-gray-300 text-gray-700 "><div className='bg-blue-100 w-max px-2 border none rounded dark:text-gray-500'>{u.RideNo}</div></td>
...
<td className="px-4 py-3">
  ...
  >
    {u.RideStatus}
                    ...
                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 not-even:">{u.createdAt}</td>
                  </tr>
                ))}
              </tbody>
