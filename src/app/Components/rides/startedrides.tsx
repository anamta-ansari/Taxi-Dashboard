...
export default function STARTEDRIDES() {
    const router = useRouter();

    const [users, setUsers] = useState([
        { id: '1', RideNo: '#100105', Rider: 'Pickup Mo', Driver: "Daniel Miller", Service: 'Cab', ServiceCategory: 'Ride', PaymentStatus: "Failed", RideStatus: "Requested", Total: '74.75$', status: 'active', createdAt: '2025-01-23 11:22:04 AM' }
    ]);
                            ...
                            <tbody>
                                {users.map((u) => (
                                    <tr key={u.id} className="border-b ">
                                        ...
                                        <td className="px-4 py-3 text-gray-700 "><div className='bg-blue-100 w-max px-2 border rounded'>{u.RideNo}</div></td>
                                        <td className="px-4 py-3">
