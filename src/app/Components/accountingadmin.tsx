...
export default function Accountingadmin() {
  ...
  return (
    <>
      <div>
        <h1 className="text-2xl font-semibold text-gray-900 mb-2">Admin Wallet</h1>
        <p className="text-sm text-gray-500">Statistics for Nov</p>


        <div className="flex flex-col sm:flex-row gap-2 my-5">
          <div className="bg-white rounded-lg border flex flex-col items-centre shadow w-full sm:w-1/2 py-5 px-2">
            {/* Top row: text + number */}
            <div className="flex justify-between gap-2">
              <span className="font-semibold text-gray-700">Total Balance</span>
              <span className=" text-black">29587.00</span>
            </div>
          ...
          <div className="flex flex-col gap-4 w-full sm:w-1/2">
            {/* Revenue Card */}
            <div className="flex justify-between items-center p-5 rounded-2xl bg-white shadow-sm border">
              {/* Left */}
              ...
              <div className="text-right">
                <p className="text-xl font-semibold text-gray-900">$29,672.60 USD</p>
            ...
            <div className="flex justify-between items-center p-5 rounded-2xl bg-white shadow-sm border">
              ...
              {/* Right */}
              <div className="text-right">
                <p className="text-xl font-semibold text-gray-900">$89.00 USD</p>
            ...
            <div className="flex justify-between items-center p-5 rounded-2xl bg-white shadow-sm border">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-600 font-medium">User wallet balances</span>
              </div>

              {/* Right */}
              <div className="text-right">
                <p className="text-xl font-semibold text-gray-900">$31.00 USD</p>
                <p className="text-sm text-red-500">%0 $0.00 Today</p>
              </div>
            </div>
        ...
        <div className="flex flex-col sm:flex-row gap-2 my-5">
          <div className="bg-white rounded-lg border flex flex-col items-centre shadow w-full sm:w-1/2 py-5">
            <p className="text-sm text-black  pl-5 mb-2">Balance Analysis</p>
            <p className="text-sm text-gray-500 mb-40  pl-5">Balance Analysis for the selected period</p>
          </div>
          <div className="bg-white rounded-lg border flex flex-col items-centre shadow w-full sm:w-1/2 py-5">
            <p className="text-sm text-black  pl-5 mb-2">Expense Breakdown</p>
            <p className="text-sm text-gray-500  pl-5 mb-40">Breakdown of expenses</p>
          </div>
        </div>

        {/* ---------------------second section ends here---------------------------- */}

        <div className="bg-white rounded-lg border flex flex-col items-centre shadow w-full py-5 mb-5">
          <p className="text-sm text-black  pl-5 mb-2">Revenue and profit</p>
          <p className="text-sm text-gray-500 mb-40  pl-5">Revenue and profit for the selected period</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between">
          <div className="flex justify-between">
            <p className="text-[18px] text-gray-800">Financial Records</p>
          ...
          <div className="hidden sm:flex gap-2">
            ...
            <button className="border text-black rounded py-2 px-4">Print</button>
            <button className="border text-blue-700 rounded py-2 px-4">Insert</button>
          </div>
        ...
        <div className="flex flex-wrap sm:flex-nowrap items-center gap-3 mb-4">
          ...
          <div className="relative w-full sm:w-auto mt-2 sm:mt-0">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-300 rounded-md text-sm w-[80%] sm:w-auto"
            >
